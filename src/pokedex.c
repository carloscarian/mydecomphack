...
static const struct SearchOptionText sDexSearchTypeOptions[] =
{
    ...
    {gText_DexEmptyString, gTypesInfo[TYPE_NORMAL2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_FIGHTING2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_FLYING2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_POISON2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_GROUND2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_ROCK2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_BUG2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_GHOST2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_STEEL2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_FIRE2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_WATER2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_GRASS2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_ELECTRIC2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_PSYCHIC2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_ICE2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_DRAGON2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_DARK2].name},
    {gText_DexEmptyString, gTypesInfo[TYPE_FAIRY2].name},
    {},
};
